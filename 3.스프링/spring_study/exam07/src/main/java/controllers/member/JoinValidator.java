...
public class JoinValidator implements Validator {
     ...
     * @param errors contextual state about the validation process / 검증 실패 시 에러 정보를 처리
     */
    @Override
    public void validate(Object target, Errors errors) {
         ...
         * 2. 중복 아이디 여부 체크
         * 3. 아이디 최소 자리수(6자리 이상) 체크 - 0
         * 4. 비밀번호 최소 자리수(8자리 이상) 체크 - 0
         * 5. 이메일 값은 필수는 아니지만 값이 있으면 형식 체크 - 0
         * 6. 비밀번호, 비밀번호 확인 일치여부
         */
